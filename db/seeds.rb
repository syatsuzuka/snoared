...
gear3 = Gear.create!(title: "CAPiTA Spring Break Powder Twin Snowboard ​+ Union Force Pro Snowboard Bindings 2022", description: "Yeah, that's right: CAPiTA Spring Break Powder Twin Snowboard. Powder. Twin. It makes sense when you remember the surfy, playful, don't-take-yourself-so-seriously ethos of the Spring Break line. The Powder Twin keeps the extra wide waist, the tight, carvey turn radius, and gentle Surf Rocker profile of its directional cousins, but packages them together in a Twin shape that's perfect for playful freestyle powder riding. Grab your homies and get to work that backcountry booter you've been talking about for years, this is the board you've been waiting for.", img_url: 'https://images.evo.com/imgp/700/225708/904343/capita-spring-break-powder-twin-snowboard-union-force-pro-snowboard-bindings-2022-.jpg', price: 2390.0, address: "Otari Mura, Kitaazumi District, Nagano, Japan", user: user4)
